...
def main():
    parser = argparse.ArgumentParser(
        description="Automation Compile: Kirim soal ke /chat dan kompilasi hasil ke 1 file besar."
    )
    ...
    print(f"[INFO] Mode: Compile All-in-One File\n")
    ...
    for item in questions:
        ...
        # Jika skip-existing aktif dan file satuan sudah ada, baca dari file lokal untuk dikompilasi
    ...
    if compiled_results:
        ...
        with open(compiled_file_path, "w", encoding="utf-8") as f:
            f.write(f"=== REKAPITULASI JAWABAN MODEL: {args.model_name} ===\n")
